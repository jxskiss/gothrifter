...
// serverOpts is clientOpts needed to run a thrift Server
...
func Logger(log *log.Logger) func(*serverOpts) {
	return func(opts *serverOpts) {
		opts.log = log
	}
}

func defaultServerOptions(serverTransport ServerTransport) *serverOpts {
	return &serverOpts{
		serverTransport:        serverTransport,
